...
{
    /// <summary>
    /// Контролер для операцій з номером телефону користувача.
    /// ------------------------------------------------------
    /// Методи:
    ///     -- Додати новий номер телефону до профілю
    ///     -- Підтвердити номер телефону
    ///     -- Надіслати код для підтвердження номеру телефону повторно
    ///     -- Отримати інформацію про номер телефону
    ///     -- Видалити номер телефону
    ///     -- Оновити налаштування СМС-сповіщень
    /// </summary>
    [Authorize]
    [ApiController]
