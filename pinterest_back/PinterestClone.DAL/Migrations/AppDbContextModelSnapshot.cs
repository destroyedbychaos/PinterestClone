...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PinterestClone.DAL.Models.BlockedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PinterestClone.DAL.Models.KeywordFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PinterestClone.DAL.Models.MarketplaceListing", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("SellerWalletAddress");
            ...
            modelBuilder.Entity("PinterestClone.DAL.Models.SocialPermissions", b =>
                {
                    ...
                    b.Property<string>("EveryoneMessagesSetting")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<bool>("FilterMyComments")
                        .HasColumnType("boolean");

                    b.Property<bool>("FilterOthersComments")
                        .HasColumnType("boolean");

                    b.Property<string>("FollowersMessagesSetting")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("FollowingMessagesSetting")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("FriendsMessagesSetting")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("MentionsSetting")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PinterestClone.DAL.Models.BlockedUser", b =>
                {
                    b.HasOne("PinterestClone.DAL.Models.Identity.User", "Blocked")
                        .WithMany()
