...
const AccountDeletion = () => {
  ...
  const handleConfirmDeletion = async () => {
    ...
    try {
      ...
      alert('Account deleted successfully! You will be logged out and redirected to the home page.');
  ...
  return (
    <Box className="deletion-container">
      <SideMenu />
      
      <Box className="deletion-main-content">
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                Deleting your account means you won't be able to get your Aests or boards back.<br/>
                All of your Aestify account data will be deleted.
              </span>
            </div>
          ...
          <Box sx={{
            ...
            <Box sx={{
              ...
              <Typography sx={{
                ...
                Please note that you will not be able to recover your account, Aests, boards, messages etc. It will be permanently deleted.
              </Typography>
              ...
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <Typography sx={{
                    ...
                    If this is your final decision and you wish to proceed, we will send you a confirmation e-mail to:
                  </Typography>
                </Box>
                <Typography sx={{
                  alignSelf: 'stretch',
                ...
                <Box sx={{
                  ...
                  <Box sx={{
                    ...
                    <Typography sx={{
                      ...
                      {isDeleting ? 'Sending...' : 'Send e-mail'}
                    </Typography>
                  </Box>
                </Box>
              </Box>
