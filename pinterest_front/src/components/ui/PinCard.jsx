...
const PinCard = ({ image, title, description, author, tags, height, pinId, onPinHidden }) => {
  ...
  const handleSavePin = () => {
    if (isSaved) {
      ...
      setTimeout(() => {
        setIsSaved(true);
        showNotification('Пін збережено в "Profile"', 'success');
      }, 1000);
    }
  };
  ...
  return (
    <div className="pin-card">
      ...
      >
        {isSaved ? (
          <>
            <span className="pin-card__save-text">Profile</span>
          ...
          <>
            ...
            <span className="pin-card__save-text">Profile</span>
            <svg className="pin-card__save-chevron" width="16" height="16" viewBox="0 0 24 24" fill="none">
