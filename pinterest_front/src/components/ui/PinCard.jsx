...
const PinCard = ({ image, title, description, author, tags, height, pinId, onPinHidden, limitedMenu = false, hideSaveButton = false }) => {
  ...
  const handleSavePin = () => {
    if (isSaved) {
      persistUnsavePin(pinId);
      setIsSaved(false);
      showNotification('Пін видалено із збережених', 'info');
    } else {
    ...
    <div className="pin">
      ...
      {showMenu && createPortal(
        <>
          ...
          >
            {!limitedMenu && (
              <div className="menu-item" onClick={handleSeeMoreLikeThis}>
            ...
            {!limitedMenu && (
              <div className="menu-item" onClick={handleSeeFewerLikeThis}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
            ...
            <div className="menu-item" onClick={handleDownloadImage}>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
