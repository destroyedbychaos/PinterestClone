    ...
    <div className="discover-header">
      ...
      <div className="discover-header__right">
        <div className="discover-header__search" ref={searchRef}>
          ...
          <input
            type="text"
            placeholder={title === "Discover" ? "Search" : "Search your Aests"}
        ...
        {currentUser ? (
          ...
          >
            {hasUserAvatar(currentUser) ? (
              <img src={getUserAvatarUrl(currentUser)} alt="avatar" className="discover-header__avatar-img" />
            ) : (
              <span className="discover-header__avatar-img" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#eaeff9', borderRadius: '50%', width: 48, height: 48, color: '#6b7280', fontSize: '16px', fontWeight: 600 }}>
              ...
              <div className="profile-dropdown-menu" ref={menuRef} tabIndex={-1}>
                ...
                onClick={() => navigate("/profile-boards")}>
                  ...
                  <div className="profile-dropdown-menu__info">
                    <div className="profile-dropdown-menu__name">{getUserDisplayName(currentUser)}</div>
                    <div className="profile-dropdown-menu__username">@{getUserUsername(currentUser)}</div>
                  </div>
                </div>
