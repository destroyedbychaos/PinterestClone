...
const DiscoverHeader = ({ user, onSearch, onLogin, onSignup }) => {
  ...
  return (
    <div className="discover-header">
      <span className="discover-header__title">Discover</span>
      <div className="discover-header__spacer" />
      <div className="discover-header__right">
        <div className="discover-header__search">
        ...
        {user ? (
            ...
            {user.avatarUrl ? (
              ...
              <span className="discover-header__avatar-img" style={{display:'flex',alignItems:'center',justifyContent:'center',background:'#eaeff9',borderRadius:'50%',width:48,height:48}}>
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="14" cy="14" r="14" fill="#CBD7F1"/>
                  <path d="M14 14C16.2091 14 18 12.2091 18 10C18 7.79086 16.2091 6 14 6C11.7909 6 10 7.79086 10 10C10 12.2091 11.7909 14 14 14Z" fill="#8CA6C8"/>
                  <path d="M7 21C7 17.6863 9.68629 15 13 15H15C18.3137 15 21 17.6863 21 21V22H7V21Z" fill="#8CA6C8"/>
                </svg>
              </span>
            )}
          ...
          <div className="discover-header__auth-buttons">
            <button className="discover-header__login-btn" onClick={onLogin}>Login</button>
            <button className="discover-header__signup-btn" onClick={onSignup}>Sign Up</button>
          </div>
        )}
      </div>
    </div>
